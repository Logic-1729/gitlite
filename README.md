...
在之前的[Git傻瓜教程](https://notes.sjtu.edu.cn/SG0OCEhHRCqcsE30CToLxA)![](figures/01.png)中我们介绍了Git如何使用。而在本次大作业中，你需要使用 C++ 实现一个名为**GitLite**的版本管理系统，它模仿了Git的底层架构。为此，我们先简单介绍当我们在使用Git时到底发生了什么。
